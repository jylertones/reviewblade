...
export type PullRequestParameters = Endpoints['GET /search/issues']['parameters'];
export type PullRequestResponse = Endpoints['GET /search/issues']['response']['data']['items'];
